...
feature_columns = [
    tf.feature_column.categorical_column_with_hash_bucket(key="blue", hash_bucket_size=9000),
    tf.feature_column.categorical_column_with_hash_bucket(key="red", hash_bucket_size=9000)
]
